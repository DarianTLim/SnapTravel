...
public class searchResultsPage extends BaseHelper {
    ...
    public static String SEARCH_TEXT_BOX = "#root > div:nth-child(1) > div > div:nth-child(2) > div.src-omnisearch-OmnisearchContainer-___OmnisearchContainer__root-container___22jXm > div.ui.grid.container.desktop > div.row.omnisearchfield__container > div > div > input";
